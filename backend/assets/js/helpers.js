export default {
    ...
    getIceServer() {
        return {
            iceServers: [
                ...
                {
                    username: "-gayCq1qTHrU67J5s4oYpXBV6ovJh_ClEIu-Pbf3oFCJR76bHBxNEARLthyPwypUAAAAAGG_N1Vqb2hud2ljaw==",
                    credential: "d83172f4-60d1-11ec-8e73-0242ac140004",
    ...
    addChat(data, senderType) {
        ...
        let d = new Date();
        infoDiv.innerText = `${senderName} - ${d.getHours()}:${d.getMinutes()}`;
